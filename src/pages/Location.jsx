...
import { Clock, Navigation as MapPin, CalendarCheck, ExternalLink } from 'lucide-react';
                ...
                >
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="w-full h-[200px] rounded-2xl overflow-hidden mb-8 shadow-inner" // Shadow inner để bản đồ chìm vào card
                        ...
                        <div className="text-center"> {/* Căn giữa nội dung chi tiết */}
                            <motion.h3
                            ...
                            <div className="space-y-4">
                                ...
                                <motion.div variants={itemVariants} className="flex items-center justify-center space-x-3">
                                    <CalendarCheck className="w-5 h-5" style={{ color: colors.iconColor }} />
                                    <p className="text-sm sm:text-base opacity-90">
